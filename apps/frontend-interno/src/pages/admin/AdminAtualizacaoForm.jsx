    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-slate-800 tracking-tight">
              {isEdit ? 'Editar Atualização' : 'Nova Atualização'}
            </h1>
            <p className="text-slate-500 mt-1">
              {isEdit ? 'Modifique as informações da atualização abaixo.' : 'Preencha os dados para registrar uma nova atualização no sistema.'}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                placeholder="Ex: Atualização do sistema versão 2.0..."
                value={form.titulo}
            ...
            <div className="space-y-2">
              ...
              <input
                placeholder="Um resumo curto sobre o que mudou..."
            ...
            <div className="space-y-2">
              ...
              <textarea
                rows={8}
                placeholder="Escreva os detalhes das mudanças e correções aqui..."
                value={form.texto}
        ...
        <div className="mt-10 pt-6 border-t border-slate-100 flex justify-end gap-4">
          ...
          >
            <Save size={20} />
            {isEdit ? 'Salvar Alterações' : 'Publicar Atualização'}
          </button>
        </div>
...
export default AdminAtualizacaoForm;